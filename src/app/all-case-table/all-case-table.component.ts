...
@Component({
  selector: 'app-all-case-table',
  templateUrl: './all-case-table.component.html',
  styleUrls: ['./all-case-table.component.css']
})
export class AllCaseTableComponent {
  Cases: CASE[]=CaseJson;
  courts :COURT[]=DistrictJson;
  caseType: case_matter[]=CaseTypetJson;
  HebLang: Boolean = false;
